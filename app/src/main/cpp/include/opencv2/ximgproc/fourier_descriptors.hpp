...
namespace cv {
    namespace ximgproc {
        ...
        */
        class CV_EXPORTS_W ContourFitting
        ...
        */
        void estimateTransformation(InputArray src, InputArray dst, OutputArray alphaPhiST,
                                    double *dist = 0, bool fdContour = false);
        ...
        @param fdContour false then src and dst are contours and true src and dst are fourier descriptors.
        */
        CV_WRAP void estimateTransformation(InputArray src, InputArray dst, OutputArray alphaPhiST,
                                            CV_OUT double &dist, bool fdContour = false);
    ...
    */
    CV_EXPORTS_W void
    fourierDescriptor(InputArray src, OutputArray dst, int nbElt = -1, int nbFD = -1);
    ...
    */
    CV_EXPORTS_W void
    transformFD(InputArray src, InputArray t, OutputArray dst, bool fdContour = true);
    ...
    * @param fd Contour defining second shape (Target).
    */
    CV_EXPORTS_W Ptr<ContourFitting>

    createContourFitting(int ctr = 1024, int fd = 16);
