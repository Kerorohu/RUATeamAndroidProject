...
// base for two classes
     ...
     */
    CV_WRAP static Ptr<EigenFaceRecognizer>

    create(int num_components = 0, double threshold = DBL_MAX);
};
 ...
 */
CV_WRAP static Ptr<FisherFaceRecognizer>
...
/** @see setThreshold */
CV_WRAP virtual double getThreshold() const
...
CV_OVERRIDE = 0;
CV_WRAP virtual std::vector<cv::Mat>

getHistograms() const = 0;
 ...
 */
CV_WRAP static Ptr<LBPHFaceRecognizer>

create(int radius = 1, int neighbors = 8, int grid_x = 8, int grid_y = 8,
